...
function setPassword(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const user = yield database_1.db.User.findById(userId);
            if (!user) {
                (0, use_response_1.useResponse)(res, 400, 'This accout does not exist or may have been deleted. Register to continue');
                return;
            }
            if (!user.verified) {
                (0, use_response_1.useResponse)(res, 400, 'Your account has not yet been verified');
                return;
            }
            if (user.password) {
                (0, use_response_1.useResponse)(res, 400, 'Your password is already set. Log in to change it');
                return;
            }
